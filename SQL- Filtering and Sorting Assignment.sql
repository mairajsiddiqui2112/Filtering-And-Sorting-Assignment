-- SQL Filtering and Sorting Assessment - Database Creation Script
-- Create tables using MySQL Workbench

-- Step 1: Create the database
CREATE DATABASE IF NOT EXISTS SQLFiltering;
...
CREATE TABLE Employees (
  ...
  (108,'Simran Kaur','Finance','Mumbai',58000,'2021-08-13'),
...
SELECT EmpName,Salary,Department,City FROM Employees
